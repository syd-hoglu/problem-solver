...
/**
 * This class represents a graph of vertices. A vertex's neighbors in the graph
 * are represented using an adjacency list. Adjacency lists are looked up using
 * a hash map.
 *
 * @author tcolburn
 */
public class Graph {
    ...
    /**
     * Creates a string representation of this graph's adjacency list for
     * testing.
     *
