...
/**
 * This class provides methods for searching graphs and displaying the results
 * of searching.
 *
 * @author tcolburn
 */
public class GraphSearcher {
    ...
    /**
     * The core search operation for this graph. It uses a double-ended queue so
     * that either breadth-first or depth-first search can be performed
     * depending on to which end of the queue newly discovered vertices are
     * added.
     *
     * @param start The start vertex for the search
     */
    ...
    /**
     * Adds a vertex to the double-ended queue. If the adder adds to the end,
     * BFS results; if the adder adds to the beginning, DFS results.
     *
     * @param v
     */
    ...
    /**
     * An initializing operation for the core search operation. All vertices are
     * set to open with null predecessors and a distance of inifinity from the
     * start.
     */
    ...
    /**
     * An initializing operation for individual vertices in preparation for a
     * search.
     *
    ...
    /**
     * A large number used to represent infinity for the search operations. It
     * is public just so test classes can use it.
     */
