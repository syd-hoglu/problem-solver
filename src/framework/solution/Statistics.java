...
public class Statistics {
    ...
    /**
     * Creates a new statistics object. Statistics are integers stored on a hash
     * map keyed by strings representing the statistics names.
     */
    public Statistics() {
    ...
    /**
     * Sets the header for this set of statistics. The header will be used as a
     * title for the statistics display string.
     *
    ...
    /**
     * Produces a list of the statistics' names and values, with the header used
     * for a title.
     *
